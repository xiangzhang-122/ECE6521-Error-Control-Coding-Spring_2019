% extracts the code component of a turobo code
% input: recv_seq -- code or received signal for the code
%OUTPUT: r_0--- info sequqence
%        r_1 ---- parity seq for of encoder 1
%        r_2 ----parity seq of encoder 2 (interleaved)
function [r_0, r_1, r_2] = code_compo_extract(recv_seq, punc_flag)
