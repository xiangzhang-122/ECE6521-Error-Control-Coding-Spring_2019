...
N_iter_dec = 4;  % turbo ddecoding # of iterations
%%
...
for kk = 1: length(symbol_snr_dB)
    ...
    for jj =1: N_c(kk)
                ...
                sigma_n_2 = 2/symbol_snr(kk);  %% noise power
                noise_vec = complex_noise(1, Num_symbol, sigma_n_2);    % total noise power = sigma_n_2
